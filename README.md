...
> **[여기를 지우고 Preview 모드 스크린샷 캡처본을 넣어주세요]**
> 
> ![Preview 모드 실행 화면](./preview_screenshot.png)

> **[여기를 지우고 Record 모드 (빨간색 REC 표시) 스크린샷 캡처본을 넣어주세요]**
> 
> ![Record 모드 실행 화면](./record_screenshot.png)
